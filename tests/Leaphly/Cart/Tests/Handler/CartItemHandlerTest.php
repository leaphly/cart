...
use Leaphly\Cart\Handler\CartItemHandler;
...
class CartItemHandlerTest extends \PHPUnit_Framework_TestCase {
    ...
    {
        $this->cartManagerWriterMock = $this->getMock('Leaphly\Cart\Model\CartManagerWriterInterface');

        $this->productFamilyProviderMock = $this->getMock('Leaphly\Cart\Provider\ProductFamilyProviderInterface');
    ...
    public function testPostItem()
    {
        ...
        $cartItemHandlerMock = $this->getMock('Leaphly\Cart\Handler\ItemHandlerInterface');
        $cartMock = $this->getMock('Leaphly\Cart\Model\CartInterface');
        $cartItemMock = $this->getMock('Leaphly\Cart\Model\ItemInterface');
        ...
        $this->dispatcher->expects($this->at(0))
            ->method('dispatch')
            ->with($this->equalTo(LeaphlyCartEvents::ITEM_CREATE_SUCCESS), $this->isInstanceOf('\Leaphly\Cart\Event\ItemEvent'));

        $this->dispatcher->expects($this->at(1))
            ->method('dispatch')
            ->with($this->equalTo(LeaphlyCartEvents::ITEM_CREATE_COMPLETED), $this->isInstanceOf('\Leaphly\Cart\Event\ItemEvent'));
    ...
    {
        $cartItemMockProductA = $this->getMock('Leaphly\Cart\Model\ItemInterface');
        $cartItemMockProductB = $this->getMock('Leaphly\Cart\Model\ItemInterface');
        ...
        $this->dispatcher->expects($this->exactly(2))
            ->method('dispatch')
            ->with($this->equalTo(LeaphlyCartEvents::ITEM_DELETE_COMPLETED), $this->isInstanceOf('\Leaphly\Cart\Event\ItemEvent'));
