...
namespace Leaphly\Cart\Tests\Doctrine;

use Leaphly\Cart\Doctrine\CartManager;
use Leaphly\Cart\Model\Cart;

/**
 * @author Giulio De Donato <liuggio@gmail.com>
 * @package Leaphly\Cart\Tests\Doctrine
 */
class CartManagerTest extends \PHPUnit_Framework_TestCase
{
    const USER_CLASS = 'Leaphly\Cart\Tests\Doctrine\DummyCart';
